// Package linkoerr implements functions to construct errors with `slog.attrs` and extract them.
package linkoerr
...
// WithAttrs returns an *errWithAttrs
...
// case of duplicate keys, the outermost values takes precedence.
